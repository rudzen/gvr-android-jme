...
public class QuixoteActivity extends AndroidGvrHarness implements GvrView.StereoRenderer {

    private static final String TAG = "QuixoteActivity";
    ...
    public QuixoteActivity() {
        super();
        appClass = Quixote.class.getCanonicalName();
    }
    ...
    public void initializeGvrView() {
        ...
        gvrView.setOnCardboardBackListener(new BackPressedRunnable());
        setGvrView(gvrView);
    }
    ...
    */
    ...
    private class BackPressedRunnable implements Runnable {
        @Override
        public void run() {
            onBackPressed();
        }
